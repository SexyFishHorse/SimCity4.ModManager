...
public abstract class RarHandlerTest : IDisposable
{
    ...
    private static readonly string ArchivePath = Path.Combine("TestFiles", "rar", "archive.rar");
    ...
    public class TheExtractFilesToTempMethod : RarHandlerTest
    {
        [Fact]
    ...
    public class TheMoveFilesToUserFolderMethod : RarHandlerTest
    {
        [Fact]
