...
public class PluginMatcher : IPluginMatcher
{
    ...
    public Plugin GetMostLikelyPluginForGroupOfFiles(IEnumerable<SimCity4.ModManager.App.Model.PluginFile> fileInfos)
    {
    ...
    public IDictionary<SimCity4.ModManager.App.Model.PluginFile, Plugin> GetMostLikelyPluginForEachFile(ICollection<SimCity4.ModManager.App.Model.PluginFile> inputFiles, BackgroundWorker backgroundWorker)
    {
        var output = new Dictionary<SimCity4.ModManager.App.Model.PluginFile, Plugin>();
        ...
        foreach (var inputFile in inputFiles)
        {
            ...
            backgroundWorker.ReportProgress(
                ...
                $"Checked {filesProcessed} out of {numFiles} files");
        }
